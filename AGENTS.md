...
## Channel state (2026-09-24, v1.0.1)
...
Chocolatey approved 1.0.0 on 2026-09-24, so the README names `choco install`.
v1.0.1's own push was refused (`403`) while 1.0.0 sat in moderation, so 1.0.1
went out from `main` with `channel=chocolatey` the day 1.0.0 was approved, and
waits for a human like every version (`docs/cli/channel-windows.md`).
