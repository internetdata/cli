...
#   homebrew/internetdata.rb.tmpl  @VSN@            <- scripts/update-homebrew.sh
...
function declared_in() {
    ...
    case "$f" in
        ...
        *.md)   grep -oE "internetdata_[0-9][0-9.]*_[a-z0-9]+_[a-z0-9]+\.(tar\.gz|zip)|releases/download/v[0-9][0-9.]*/" "$f" ;;
