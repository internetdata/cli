...
$base = "https://github.com/internetdata/cli/releases/download/v$Version"
...
$sha386   = Get-ReleaseSha "internetdata_${Version}_windows_386.zip"
$shaAmd64 = Get-ReleaseSha "internetdata_${Version}_windows_amd64.zip"

$pkg = "chocolatey-packages/internetdata"
$work = Join-Path $env:TEMP "choco-internetdata"
Remove-Item -Recurse -Force $work -ErrorAction SilentlyContinue
Copy-Item -Recurse $pkg $work

(Get-Content "$work/internetdata.nuspec") `
    -replace '<version>.*</version>', "<version>$Version</version>" `
    -replace '@VSN@', $Version |
    Set-Content "$work/internetdata.nuspec"
...
choco pack "$work/internetdata.nuspec" --outputdirectory $work
choco push "$work/internetdata.$Version.nupkg" --source https://push.chocolatey.org/ --api-key $ApiKey
