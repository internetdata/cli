...
$zip = "internetdata_${vsn}_windows_${arch}.zip"
$url = "https://github.com/internetdata/cli/releases/download/v${vsn}/${zip}"

# Per-user, so this needs no elevation. Machine-wide installs should use the
# Chocolatey or WinGet package instead.
$dest = Join-Path $env:LOCALAPPDATA "Programs\internetdata"
...
Write-Host ""
Write-Host "installed. run 'internetdata --help'."
